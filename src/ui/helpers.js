...
const iconMap = {
  ...
  shield: `<svg class="{cls}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21.75s-7.5-4.5-7.5-10.5V5.25L12 2.25l7.5 3v6c0 6-7.5 10.5-7.5 10.5z"/></svg>`,
